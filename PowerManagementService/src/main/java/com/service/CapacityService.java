...
public class CapacityService {
	...
	public String insertCapacity(String itemData)
	{
		...
		//validating input values
		if(SupNo.isEmpty()||date.isEmpty()||Type.isEmpty()||units.isEmpty()) 
		 {
			 return "input fields cannot be empty";
		 } 
		 else if(!Type.matches("eco") && !Type.matches("non-eco")) {
			 return "Incorrect consumer type!";
		 }
	...
	public String updateCapacity(String itemData)
	{
		...
		//validating input values
		if(capID.isEmpty()||SupNo.isEmpty()||date.isEmpty()||Type.isEmpty()||units.isEmpty()) 
		 {
			 return "input fields cannot be empty";
		 } 
		 else if(!Type.matches("eco") && !Type.matches("non-eco")) {
